...
package io.vertx.ext.auth.handler.impl;
 ...
 */
public abstract class AuthenticationHandlerImpl<T extends AuthenticationProvider, C extends AuthenticationContext> implements AuthenticationHandlerInternal<C> {
   ...
   * error handling
   */
  protected void processException(C ctx, Throwable exception) {
    if (exception != null) {
  ...
  private boolean handlePreflight(AuthenticationContext ctx) {
